...
import logo from "../../../assets/teslawhite.svg";
    ...
    <>
      <nav className="hidden lg:block w-screen overflow-x-hidden">
        <header className="items-center px-6 py-4 flex justify-between">
          ...
          <ul className="flex m-4 gap-4 text-white justify-center items-center">
      ...
      <nav className="block lg:hidden w-screen overflow-x-hidden">
